    ...
    <div className="max-w-7xl mx-auto px-4 py-8 group/carousel relative">
      ...
      >
        <CarouselContent>
          ...
          <CarouselItem>
            <div className="bg-gradient-to-r from-[#FFB89E] to-[#FF8C66] rounded-3xl relative overflow-hidden flex flex-col md:flex-row min-h-[450px] md:h-[450px]">

              {/* Image (Mobile: Top, Desktop: Left) */}
              <div className="w-full h-[220px] md:h-full md:w-1/2 relative flex-shrink-0">
                <Image 
                  src="/hero.png" 
          ...
          <CarouselItem>
            <div className="bg-[#FFFDFB] rounded-3xl relative overflow-hidden flex flex-col md:flex-row min-h-[450px] md:h-[450px]">

              {/* Image (Mobile: Top, Desktop: Left) */}
              <div className="w-full h-[220px] md:h-full md:w-1/2 relative flex-shrink-0 pt-6 md:pt-0">
                <Image 
          ...
          <CarouselItem>
            <div className="bg-[#EBF1E6] rounded-3xl relative overflow-hidden flex flex-col md:flex-row min-h-[450px] md:h-[450px]">
